...
using Blogging_App_Core.Areas.Identity.Data;
...
namespace Blogging_App_Core.Areas.Identity.Pages.Account
{
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (file != null)
                {
                    ...
                    if (file.Length > 0)
                    {
                        var uniqueFileName = Input.Email + "_" + Guid.NewGuid().ToString() + "_" + file.FileName; 
                        ...
                        user.ProfilePicPath = "/uploads/" + uniqueFileName; 
                    }
